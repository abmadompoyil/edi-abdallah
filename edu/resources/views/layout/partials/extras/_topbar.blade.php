...
{{ asset('media/svg/flags/008-saudi-arabia.svg') }}"
                         alt="اللغة"
                         @else
                         {{ asset('media/svg/flags/226-united-states.svg') }}"
                        alt="Language"
                             @endif
                         />
                </div>
    ...
    @if (config('layout.extras.user.display'))
        ...
        @else
            <div class="dropdown">
                {{-- Toggle --}}
                <img  style="object-fit: cover; " height="50" src="{{asset(Auth::user()->img ?? 'edu/public/logo2.jpg')}}">
