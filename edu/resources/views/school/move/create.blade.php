    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom">
                        ...
                        <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                            ...
                            <li class="nav-item mr-3">
                                <a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1">
                                    ...
                                    <span class="nav-text font-size-lg">{{__("Add Employee")}}</span>
                                </a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                ...
                <!--begin::Card body-->
                <div class="card-body">
                    <form  method="POST" action="{{route('move.storess')}}" class="formAction">
                        @csrf
                            ...
                            <div class="tab-pane show px-7 active" id="kt_user_edit_tab_1" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 my-2">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">{{__("Old Specialization * ")}} </label>
                                            <div class="col-9">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">{{__("New Specialization * ")}} </label>
                                            <div class="col-9">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left"> {{__("Interview Date (optional) ")}}</label>
                                            <div class="col-9">
                                                    <div class="input-group input-group-lg ">

                                                        <select required  name="date_id" class="form-control" id="exampleSelect2">
                                                            <option>{{__("Appointment date available (optional)  ")}}</option>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left"> {{__("Old School * ")}}</label>
                                            <div class="col-9">
                                                    <div class="input-group input-group-lg ">

                                                        <select required  name="old_school" class="form-control" id="exampleSelect2">
                                                            <option>{{__("Old School *  ")}}</option>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left"> {{__("New  School * ")}}</label>
                                            <div class="col-9">
                                                    <div class="input-group input-group-lg ">

                                                        <select required  name="new_school" class="form-control" id="exampleSelect2">
                                                            <option>{{__("New School *  ")}}</option>
                                                            @foreach($schools as $school)
                                                                <option value="{{$school->id}}" > {{$school->name}}</option>
                                                            @endforeach
