    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom">
                        ...
                        <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                            ...
                            <li class="nav-item mr-3">
                                <a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1">
                                    ...
                                    <span class="nav-text font-size-lg">{{__("Add Consult")}}</span>
                                </a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                ...
                <!--begin::Card body-->
                <div class="card-body">
                    <form  method="POST" action="{{route('consult.store')}}" class="formAction" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 my-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <h6 class="text-dark font-weight-bold mb-10">{{__("Details Consult")}}</h6>
                                            </div>
                                        </div>
                                        <!--end::Row-->
                                        <!--begin::Group-->
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">{{__("Consult * ")}}</label>
                                            <div class="col-9">
                                        ...
                                        <div class="form-group row" >
                                            <div class="col-3 text-lg-right text-left">
                                                <label class="col-form-label  text-lg-right text-left"> {{__("Files  ")}}</label>
...
@section('scripts')
    <script>
        ...
        $(function(){
            ...
            {{--                        $('.my-pond').first().filepond('addFile', '{{asset("dark/storage/app/".$img->src)}}').then(function(file){--}}
