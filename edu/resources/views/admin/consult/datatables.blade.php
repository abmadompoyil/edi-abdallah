...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="card-body">
            <div class="row ">
                <div class="col-lg-9 ">
                    <input type="text" class="form-control datatable-input" placeholder="{{__("Name or Phone")}}" data-col-index="0" name="id" id="s_id">
                </div>
                <div class="col-lg-3">
