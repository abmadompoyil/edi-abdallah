    ...
    <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
            ...
            <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                ...
                @endif
                <!--begin::Form-->
                    <form class="form fv-plugins-framework" method="post" id="kt_login_singin_form" novalidate="novalidate" action="{{route('login')}}">
                        <!--begin::Title-->
                        @csrf
                        @if($errors->any())
                            <h4>{{$errors->first()}}</h4>
...
'}}</h4>
                            ...
                            <div class="form-group fv-plugins-icon-container" >
                                ...
                                <div class="fv-plugins-message-container">
                                    <a href="custom/pages/login/login-4/forgot.html" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">{{__("Did you forget password ?")}}</a>
                            ...
                            <div class="form-group fv-plugins-icon-container" >
                                <div class="d-flex justify-content-between mt-n5" style="    float: left;">
                                    <label class="font-size-h6 font-weight-bolder text-dark pt-5">{{__("Confirm Password")}} </label>
                                </div>
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="password" name="c_password" autocomplete="off">
                                <div class="fv-plugins-message-container">
                                    <a href="custom/pages/login/login-4/forgot.html" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">{{__("Did you forget password ?")}}</a>
