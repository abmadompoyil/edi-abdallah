                ...
                @endif
                    ...
                    <form class="form fv-plugins-framework" method="post" id="kt_login_singin_form" novalidate="novalidate" action="{{route('login')}}">
                        ...
                        <div class="pb-5 pb-lg-15">
                            <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">{{_("Login")}} </h3>
                            <h4>{{$page_title ?? ''}}</h4>
...
{{--                                <a href="{{route('register')}}" class="text-primary font-weight-bolder">أنشئ حساب جديد </a></div>--}}
                        ...
                        <div class="form-group fv-plugins-icon-container" >
                            ...
                            <div class="fv-plugins-message-container">
                                <a href="{{route('password.forget')}}" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">{{__("Did you forget password ?")}}</a>
