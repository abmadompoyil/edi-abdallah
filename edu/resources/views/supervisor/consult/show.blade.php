                        ...
                        <div class="card-body px-0">
                            <div class="tab-content pt-5">
                                ...
                                <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                                    <div class="container">
                                        <form  method="POST" action="{{route('super.consults.add',$consult->id)}}" class="form formAction">
                                            @csrf
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <select name="status" class="form-control form-control-lg form-control-solid">
                                                        <option value="pending"@if($consult->status == 'pending') selected @endif >Pending</option>
                                                        <option value="accept" @if($consult->status == 'accept') selected @endif>Accept</option>
                                                        <option value="canceled" @if($consult->status == 'canceled') selected @endif>Canceled</option>
                                                        <option value="completed" @if($consult->status == 'completed') selected @endif>Completed</option>
                                                    </select>
