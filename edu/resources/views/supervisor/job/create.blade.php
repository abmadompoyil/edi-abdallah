                            ...
                            <div class="tab-pane show px-7 active" id="kt_user_edit_tab_1" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 my-2">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">{{__("Specialization * ")}} </label>
                                            <div class="col-9">
                                                <select   name="specialization" class="form-control subject" required id="exampleSelect2">
                                                ...
                                                <input type="text" name="other"  id="other" style="display: none" class="form-control form-control-lg form-control-solid"  placeholder="Specialization">
