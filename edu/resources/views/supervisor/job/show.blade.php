                        ...
                        <div class="card-body px-0">
                            <div class="tab-content pt-5">
                                ...
                                <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                                    <div class="container">
                                        <form  method="POST" action="{{route('super.job.comments.add',$job->id)}}" class="form formAction">
                                            @csrf
                                ...
                                <div class="tab-pane" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                                        <form  method="POST" action="{{route('super.job.result.add',$job->id)}}" class="form formAction">
                                            @csrf
                                    ...
                                    @foreach($results as $result)
                                        ...
                                        <form  method="POST" action="{{route('super.job.result.update',$result->id)}}" class="form formAction">
                                            @csrf
