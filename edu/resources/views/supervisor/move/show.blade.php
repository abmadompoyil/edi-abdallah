                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center flex-wrap justify-content-between">
                                ...
                                <div class="flex-grow-1 font-weight-bold text-dark-50 py-2 py-lg-2 mr-5">
                                    <p>{{__("Old specialization")}}: <strong>{{$job->Teacher->other ?? $job->Teacher->subject()}}</strong> </p>
                                    <p>{{__("New specialization")}}   : <strong>{{$job->other ?? $job->new_subject->name}}</strong> </p>
                                    <p>{{__("Old School")}} : <strong>{{$job->Teacher->old_school->name}}</strong> </p>
                                    <p>{{__("new School")}} : <strong>{{$job->new_school->name}}</strong> </p>
                        ...
                        <div class="card-body px-0">
                            <div class="tab-content pt-5">
                                ...
                                <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                                    <div class="container">
                                        <form  method="POST" action="{{route('super.comments.add',$job->id)}}" class="form formAction">
                                            @csrf
                                            ...
                                            <div class="timeline-items">
                                                ...
                                                <div class="timeline-item">
                                                    <div class="timeline-media">
                                                        <img alt="Pic" src="{{$comment->user->img}}">
                                                    </div>
