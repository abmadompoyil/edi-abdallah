...
<div class="card card-custom bg-gray-100 {{ @$class }}">
    ...
    <div class="card-header border-0 bg-danger py-5">
        <h3 class="card-title font-weight-bolder text-white">الإحصائيات</h3>
