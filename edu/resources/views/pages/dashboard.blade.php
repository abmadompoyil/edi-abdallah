...
@section('content')
    ...
    @include('pages.widgets._widget11', ['class' => 'card-stretch gutter-b'])
...
{{--        @include('pages.widgets._widget10')--}}
    <div class="row">
        <div class="col-xxl-12 order-2 order-xxl-1">
            @include('edu.wdg._table', ['class' => 'card-stretch gutter-b'])

        </div>
        <div class="col-xxl-6 col-xxl-4 order-1 order-xxl-1">
            @include('edu.wdg._table3', ['class' => 'card-stretch gutter-b'])
        </div>
        <div class="col-xxl-6 order-2 order-xxl-1">
            @include('edu.wdg._table2', ['class' => 'card-stretch gutter-b'])
