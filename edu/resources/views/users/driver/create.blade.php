    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom">
                        ...
                        <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                            ...
                            <li class="nav-item mr-3">
                                <a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1">
                                    ...
                                    <span class="nav-text font-size-lg">إضافة عميل</span>
                                </a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                ...
                <!--begin::Card body-->
                <div class="card-body">
                    <form  method="POST" action="{{route('drivers.store')}}" class="formAction">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 my-2">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">الصورة</label>
                                            <div class="col-9">
                                                <div class="image-input image-input-empty image-input-outline" id="car_img"
                                                     style="background-image: url(/assets/media/users/blank.png)">
                                                    <div class="image-input-wrapper"></div>
                                                    <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                                        <i class="fa fa-pen icon-sm text-muted"></i>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" name="nameCar"  type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="text" name="type" class="form-control form-control-lg form-control-solid"
                                                           placeholder="النوع">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="text" name="color" class="form-control form-control-lg form-control-solid"
                                                         placeholder="اللون ">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">رخصة السيارة</label>
                                            <div class="col-9">
                                                <div class="image-input image-input-empty image-input-outline" id="car_license"
                                                     style="background-image: url(/assets/media/users/blank.png)">
                                                    <div class="image-input-wrapper"></div>
                                                    <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                                        <i class="fa fa-pen icon-sm text-muted"></i>
                                                        <input type="file" id="license" name="license" accept=".png, .jpg, .jpeg">
                                                        <input type="hidden" name="profile_avatar_remove">
                                                    </label>
                                                    <span class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="cancel" data-toggle="tooltip" title="" data-original-title="Cancel avatar">
																			<i class="ki ki-bold-close icon-xs text-muted"></i>
