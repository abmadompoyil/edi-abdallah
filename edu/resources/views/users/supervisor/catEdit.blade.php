    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom">
                        ...
                        <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                            ...
                            <li class="nav-item mr-3">
                                <a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1">
                                    ...
                                    <span class="nav-text font-size-lg">{{__("Edit User")}}</span>
                                </a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                ...
                <!--begin::Card body-->
                <div class="card-body">
                    <form  method="POST" action="{{route('supervisors.update',$user)}}" class="formAction">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 my-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <h6 class="text-dark font-weight-bold mb-10">{{__("Supervisor devils")}}:</h6>
                                            </div>
                                        </div>
                                        <!--end::Row-->
                                        <!--begin::Group-->
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">{{__("Img")}}</label>
                                            <div class="col-9">
                                        ...
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-3">
																		<span class="switch">
																			<label>
																				<input type="checkbox" @if($user->status  == 'active') checked="checked" @endif name="select">
																				<span></span>
																			</label>
																		</span>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-7">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input class="form-control form-control-lg form-control-solid" name="password" type="password" placeholder="{{__("Add new password")}}">
                                                </div>
                                            </div>
                                            <!--end::Group-->
                                            <!--begin::Group-->
                                            <div class="form-group row">
                                                <label class="col-form-label col-3 text-lg-right text-left">{{__("Confirm password")}}</label>
                                                <div class="col-9">
                                                    <input class="form-control form-control-lg form-control-solid" type="password" placeholder="{{__("Confirm new password")}}">
                                                </div>
                                            </div>
                                            <!--end::Group-->
                                        </div>
