    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom">
                ...
                <!--begin::Card body-->
                <div class="card-body">
                    <form  method="POST" action="{{route('teachers.store')}}" class="formAction">
                        @csrf
                            ...
                            <div class="tab-pane show px-7 active" id="kt_user_edit_tab_1" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 my-2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <select name="country" class="form-control  form-control-lg form-control-solid">
                                                    ...
                                                    <option value="1" >خارج السعودية</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <textarea class="form-control" name="description" id="exampleTextarea" rows="4"></textarea>                                            </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <input type="text" name="video" class="form-control form-control-lg form-control-solid"  placeholder=" رابط اليوتيوب  ">
                                                </div>
                                            </div>
                                        </div>
