    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom">
                ...
                <!--begin::Card body-->
                <div class="card-body">
                    <form  method="POST" action="{{route('admin.update',$user)}}" class="formAction">
                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <select name="role" class="form-control  form-control-lg form-control-solid">
                                                    ...
                                                    <option value="1" @if($user->role == 1 ) selected @endif>  مدير مسئول </option>
                                                    <option value="2" @if($user->role == 2 ) selected @endif>مشرف </option>
                                                    <option value="3" @if($user->role == 3 ) selected @endif>مراقب </option>
                                                </select>
                                            </div>
                                        </div>
