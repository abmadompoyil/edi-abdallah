    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom">
                        ...
                        <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                            ...
                            <li class="nav-item mr-3">
                                <a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1">
                                    ...
                                    <span class="nav-text font-size-lg">{{__("Add New Time Meeting")}}</span>
                                </a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                ...
                <!--begin::Card body-->
                <div class="card-body">
                    <form  method="POST" action="{{route('meeting.store')}}" class="formAction">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 my-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <h6 class="text-dark font-weight-bold mb-10">{{__("Add new Meeting Date")}}</h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left"> {{__("Stat Time")}}</label>
                                            <div class="col-9">
                                                <div class="input-group input-group-lg ">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left"> {{__("End Time")}}</label>
                                            <div class="col-9">
                                                <div class="input-group input-group-lg ">
...
@section('scripts')
    <script>
        ...
        {
            var j = zeroFill(i, 2);
            selection += "<option value='"+ j +":00:00'>"+ j + ":00:00" + "</option>";
        }
