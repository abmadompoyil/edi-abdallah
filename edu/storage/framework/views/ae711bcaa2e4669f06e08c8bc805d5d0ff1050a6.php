    ...
    <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
            ...
            <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                ...
                <?php endif; ?>
                    <!--begin::Form-->
                    <form class="form fv-plugins-framework" method="post" id="kt_login_singin_form" novalidate="novalidate" action="<?php echo e(route('login')); ?>">
                        <!--begin::Title-->
                        <?php echo csrf_field(); ?>
                        <?php if($errors->any()): ?>
                        ...
                        <div class="pb-5 pb-lg-15">
                            <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg"><?php echo e(_("Login")); ?> </h3>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group fv-plugins-icon-container">
                            <label class="font-size-h6 font-weight-bolder text-dark"><?php echo e(__("Email")); ?></label>
                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="email" value="<?php echo e(old('Email')); ?>" name="email" autocomplete="off">
                            <div class="fv-plugins-message-container">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group fv-plugins-icon-container" >
                            ...
                            <div class="fv-plugins-message-container">
                                <a href="custom/pages/login/login-4/forgot.html" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5"><?php echo e(__("Did you forget password ?")); ?></a>
...
<?php /**PATH /home4/softc92r/alfarismedia.com/edu/resources/views/auth/login-2.blade.php ENDPATH**/ ?>