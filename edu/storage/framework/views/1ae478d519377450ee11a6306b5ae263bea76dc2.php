    ...
    <?php if(config('layout.extras.user.display')): ?>
        ...
        <?php else: ?>
            <div class="dropdown">
                ...
                <img  style="object-fit: cover; " height="50" src="<?php echo e(asset(Auth::user()->img ?? 'edu/public/logo2.jpg')); ?>">
...
<?php /**PATH /home4/softc92r/edu.ixmedia.tech/edu/resources/views/layout/partials/extras/_topbar.blade.php ENDPATH**/ ?>