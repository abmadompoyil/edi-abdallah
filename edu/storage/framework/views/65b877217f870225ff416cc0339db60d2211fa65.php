    ...
    <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
            ...
            <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                ...
                <?php endif; ?>
                <!--begin::Form-->
                    <form class="form fv-plugins-framework" method="post" id="kt_login_singin_form" novalidate="novalidate" action="<?php echo e(route('password.code')); ?>">
                        <!--begin::Title-->


                        <div class="pb-5 pb-lg-15">
                            <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg"><?php echo e(_("Enter Code to reset password")); ?> </h3>
                            <h4><?php echo e($page_title); ?></h4>
                            <div class="text-muted font-weight-bold font-size-h4"><?php echo e(__(" we sent code to your email plaese enter it here ")); ?>
...
<?php /**PATH /home4/softc92r/edu.ixmedia.tech/edu/resources/views/auth/passwords/confirm.blade.php ENDPATH**/ ?>