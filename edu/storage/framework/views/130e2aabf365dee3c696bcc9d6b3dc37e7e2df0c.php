    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom">
                        ...
                        <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                            ...
                            <li class="nav-item mr-3">
                                <a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1">
                                    ...
                                    <span class="nav-text font-size-lg"><?php echo e(__("Recruitment ")); ?></span>
                                </a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                ...
                <!--begin::Card body-->
                <div class="card-body">
                    <form  method="POST" action="<?php echo e(route('job.store')); ?>" class="formAction" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
">
                                        ...
                                        <div class="form-group row" id="specialization" style="display: none" >
                                            <label class="col-form-label col-3 text-lg-right text-left"> <?php echo e(__("Specialization of Bachelor")); ?></label>
                                            <div class="col-9">
                                        ...
                                        <div class="form-group row" >
                                            <div class="col-3 text-lg-right text-left">
                                                <label class="col-form-label  text-lg-right text-left"> <?php echo e(__("Teaching practicing license ")); ?></label>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left"><?php echo e(__("Sub Teacher * ")); ?> </label>
                                            <div class="col-9">
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/softc92r/edu.ixmedia.tech/edu/resources/views/school/job/create.blade.php ENDPATH**/ ?>