                ...
                <?php if(config('layout.aside.self.display') == false): ?>
                    <div class="header-logo">
                        <a href="<?php echo e(url('/admin')); ?>">
                            <img alt="Logo"  height="60" src="<?php echo e(asset('media/logos/'.$kt_logo_image)); ?>"/>
                        </a>
                    </div>
                <?php endif; ?>
...
<?php /**PATH /home4/softc92r/alfarismedia.com/edu/resources/views/layout/base/_header.blade.php ENDPATH**/ ?>