...
<div class="card card-custom <?php echo e(@$class); ?>">
    ...
    <div class="card-header border-0">
        <h3 class="card-title font-weight-bolder text-dark"><?php echo e(__('admin.teachers')); ?></h3>
        ...
        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="d-flex align-items-center mb-10">
                ...
                <div class="d-flex flex-column flex-grow-1 font-weight-bold">
                    ...
                    <span class="text-muted">   <?php echo e($user->Teacher->nameOfCat() ?? null); ?> </span>
                    <?php endif; ?>
...
<?php /**PATH /home4/softc92r/alfarismedia.com/edu/resources/views/pages/widgets/_widget-9.blade.php ENDPATH**/ ?>