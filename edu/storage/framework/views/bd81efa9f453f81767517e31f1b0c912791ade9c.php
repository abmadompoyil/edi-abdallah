        ...
        <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="deleted-row-<?php echo e($job->id); ?>">
                ...
                <td>
                    ...
                    <a href="javascript:;" data-href="<?php echo e(route('super.move.catDelete',$job->id)); ?>" data-entity_id="<?php echo e($job->id); ?>" data-token="<?php echo e(csrf_token()); ?>" class="btn delete-btn btn-sm btn-clean btn-icon" data-toggle="tooltip" title="حدف">
...
<?php /**PATH /home4/softc92r/edu.ixmedia.tech/edu/resources/views/supervisor/move/table.blade.php ENDPATH**/ ?>