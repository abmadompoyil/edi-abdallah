...
<div class="card card-custom <?php echo e(@$class); ?>">
    ...
    <div class="card-body pt-3 pb-0">
        ...
        <?php
            $consults = \App\Edu\Consult::where('school_id',Auth::user()->id)->latest('created_at')->take(5)->get();
        ?>
...
<?php /**PATH /home4/softc92r/edu.ixmedia.tech/edu/resources/views/school/wdg/_table2.blade.php ENDPATH**/ ?>