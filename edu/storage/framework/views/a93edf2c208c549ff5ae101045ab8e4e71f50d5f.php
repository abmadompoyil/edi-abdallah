                        ...
                        <div class="card-body px-0">
                            <div class="tab-content pt-5">
                                ...
                                <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                                    <div class="container">
                                        <form  method="POST" action="<?php echo e(route('super.job.comments.add',$job->id)); ?>" class="form formAction">
                                            <?php echo csrf_field(); ?>
                                ...
                                <div class="tab-pane" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                                        <form  method="POST" action="<?php echo e(route('super.job.result.add',$job->id)); ?>" class="form formAction">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/softc92r/edu.ixmedia.tech/edu/resources/views/supervisor/job/show.blade.php ENDPATH**/ ?>