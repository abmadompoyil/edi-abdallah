    ...
    <div class="brand flex-column-auto <?php echo e(Metronic::printClasses('brand', false)); ?>" id="kt_brand">
        <div class="brand-logo">
            <a href="<?php echo e(url('/')); ?>">
                <img alt="<?php echo e(config('app.name')); ?>" height="50" src="<?php echo e(asset('assets/QALogomark.png')); ?>"/>
            </a>
        </div>
...
<?php endif; ?>
       <?php elseif(Auth::user()->isSchool()): ?>
           ...
           <?php else: ?>
               ...
               <?php endif; ?>
       <?php elseif(Auth::user()->isSuperViser()): ?>
           <?php if(\Illuminate\Support\Facades\App::getLocale() == 'ar'): ?>
               <div
                   id="kt_aside_menu"
                   class="aside-menu my-4 <?php echo e(Metronic::printClasses('aside_menu', false)); ?>"
...
<?php /**PATH /home4/softc92r/alfarismedia.com/edu/resources/views/layout/base/_aside.blade.php ENDPATH**/ ?>