                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <div class="mr-3">
                                    <div class="d-flex align-items-center mr-3">
                                        ...
                                        <!--end::Name-->
                                        <span class="label label-light-success label-inline font-weight-bolder mr-1"><?php echo e($job->Teacher->subject->name); ?></span>
                                    </div>
                                    <!--begin::Contacts-->
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body pt-2">
                            ...
                            <?php if($job->Teacher->resume != null): ?>
                                                    <div class="card-footer">
                                                        <a href="<?php echo e($job->Teacher->resume); ?>" download class="btn btn-primary font-weight-bold mr-2">Download resume</a>
                                                    </div>
                                <?php endif; ?>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/softc92r/alfarismedia.com/edu/resources/views/school/job/show.blade.php ENDPATH**/ ?>