        ...
        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="deleted-row-<?php echo e($user->id); ?>">
                ...
                <td>
                    ...
                    <a href="<?php echo e(route('schools.edit',$user)); ?>" data-href="<?php echo e(route('schools.edit',$user)); ?>" data-entity_id="<?php echo e($user->id); ?>"  class="btn  btn-sm btn-clean btn-icon" data-toggle="tooltip" title="تعديل">
...
<?php /**PATH /home4/softc92r/alfarismedia.com/edu/resources/views/users/schools/table.blade.php ENDPATH**/ ?>