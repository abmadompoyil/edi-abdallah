        ...
        <?php $__currentLoopData = $consults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consult): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="deleted-row-<?php echo e($consult->id); ?>">
                ...
                <td >
                    ...
                    <?php echo e($consult->school->name); ?>

                </td>
                <td >
                    <?php echo e($consult->SuperVisor->name ?? 'there no supervisor right no '); ?>
                ...
                <td>
                    ...
                    <a href="<?php echo e(route('admin.consults.show',$consult->id)); ?>" data-href="<?php echo e(route('admin.consults.show',$consult->id)); ?>" data-entity_id="<?php echo e($consult->id); ?>"  class="btn  btn-sm btn-clean btn-icon" data-toggle="tooltip" title="show">
                        <?php echo e(Metronic::getSVG("media/svg/icons/General/Expand-arrows.svg", "svg-icon-md svg-icon-primary")); ?>


                    </a>
                    <a href="javascript:;" data-href="<?php echo e(route('admin.consults.catDelete',$consult->id)); ?>" data-entity_id="<?php echo e($consult->id); ?>" data-token="<?php echo e(csrf_token()); ?>" class="btn delete-btn btn-sm btn-clean btn-icon" data-toggle="tooltip" title="حدف">
...
<?php /**PATH /home4/softc92r/edu.ixmedia.tech/edu/resources/views/admin/consult/table.blade.php ENDPATH**/ ?>