...
<?php echo e(asset('media/svg/flags/008-saudi-arabia.svg')); ?>"
                         alt="اللغة"
                         <?php else: ?>
                         <?php echo e(asset('media/svg/flags/226-united-states.svg')); ?>"
                        alt="Language"
                             <?php endif; ?>
                         />
                </div>
            ...
            <div class="topbar-item">
                <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    ...
                    <span class="symbol symbol-35 symbol-light-success">
                        <span class="symbol-label font-size-h5 font-weight-bold"><?php echo e(Auth::user()->name[0]); ?></span>
                    </span>
                </div>
            </div>
        <?php else: ?>
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
                    <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2">
                        <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1"><?php echo app('translator')->get('admin.hi'); ?>,</span>
                        <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?php echo e(Auth::user()->name); ?></span>
                        <span class="symbol symbol-35 symbol-light-success">
                            <span class="symbol-label font-size-h5 font-weight-bold"><?php echo e(Auth::user()->name[0]); ?></span>
                        </span>
...
<?php /**PATH /home4/softc92r/alfarismedia.com/edu/resources/views/layout/partials/extras/_topbar.blade.php ENDPATH**/ ?>