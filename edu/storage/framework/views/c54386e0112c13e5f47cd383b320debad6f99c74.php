...
<div class="subheader pt-2 pb-2 <?php echo e(Metronic::printClasses('subheader', false)); ?>" id="kt_subheader">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
                <a href="#" class="btn btn-sm btn-clean btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?php echo e(Metronic::getSVG( "media/svg/icons/Files/File-plus.svg", "svg-icon-success svg-icon-lg")); ?>
...
<?php /**PATH /home4/softc92r/edu.ixmedia.tech/edu/resources/views/layout/partials/subheader/_subheader-v3.blade.php ENDPATH**/ ?>