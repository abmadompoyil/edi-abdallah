...
<div class="card card-custom <?php echo e(@$class); ?>">
    ...
    <div class="card-header border-0">
        <h3 class="card-title font-weight-bolder text-dark"><?php echo e(__('Others files Library')); ?></h3>
    ...
    <div class="card-body pt-2">
        ...
        <?php
            $files = \App\Edu\Library::where('type',3)->latest('created_at')->take(5)->get()
        ?>
...
<?php /**PATH /home4/softc92r/edu.ixmedia.tech/edu/resources/views/pages/widgets/_widget-9.blade.php ENDPATH**/ ?>