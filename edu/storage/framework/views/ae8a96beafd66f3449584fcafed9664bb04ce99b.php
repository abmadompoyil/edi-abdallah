<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
                          <form  method="POST" action="<?php echo e(route('files.store')); ?>" class="formAction" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
    <input type="hidden" value="<?php echo e($type); ?>" name="type">
        ...
        <div class="card-body" id="card-body">
            ...
            <?php echo $__env->make('admin.files.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/softc92r/edu.ixmedia.tech/edu/resources/views/admin/files/datatables.blade.php ENDPATH**/ ?>