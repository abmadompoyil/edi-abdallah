    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom">
                ...
                <!--begin::Card body-->
                <div class="card-body">
                    <form  method="POST" action="<?php echo e(route('supervisors.store')); ?>" class="formAction">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/softc92r/edu.ixmedia.tech/edu/resources/views/users/supervisor/create.blade.php ENDPATH**/ ?>