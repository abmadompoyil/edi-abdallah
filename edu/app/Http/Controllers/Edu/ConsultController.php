...
class ConsultController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            return view('admin.consult.table', compact('consults'))->render();
        }
        return view('admin.consult.datatables', compact('page_title', 'page_description','consults'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.consult.create', compact('page_title', 'page_description'));
    }
...
//                $path = $file->store('consult/files');
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Consult $consult,Request $request,$id)
    {
        ...
        return view('admin.consult.show', compact('page_title', 'page_description','consult','school','comments'));
    }
